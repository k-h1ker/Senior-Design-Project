...
data_training = pd.read_csv('whites_d1_5mm_boot.csv')  #we train on the boot strapped data
data_test = pd.read_csv('whites_d1_5mm.csv')           #we test on the actual
...
#    f = open("whites_d1_5mm_model.txt", "w+")
#    m = pickle.dumps(pls)
#    f.write(m)
